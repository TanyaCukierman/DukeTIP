...
for i in range(10):
    id = movieRatingS[i][0]
    print(movieDict[id]+" "+str(movieRatingS[i][0])+" "+str(movieRatingS[i][1])+" "+str(movieRatingCount[id][1]))
...
for l in range(10):
    ...
    if movieRatingCount[ld] >= 100:
        print(movieDict[ld]+" "+str(movieRatingS[l][0])+" "+str(movieRatingS[l][1])+" "+str(movieRatingCount[ld][1]))
